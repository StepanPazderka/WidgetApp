...
struct ContentView: View {
    ...
    func loadSettings(forWidgetNo: Int, widgetSize: WidgetTypes) {
        ...
        let readData = sharedDefaults?.object(forKey: "\(forWidgetNo)-widgetContent") as? String
        ...
        self.textfielContent = readData ?? "This is a preview text that will be in the widget"
        if let readData, readData.isEmpty {
